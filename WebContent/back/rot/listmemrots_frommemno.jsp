...
<%
    ...
    List<RotVO> listRots_frommemno =(List)request.getAttribute("listRots_frommemno");
    pageContext.setAttribute("listRots_frommemno",listRots_frommemno);
...
<div id="backmain" class="col-md-10">
	<h1 class="page-header">來自會員編輯的路線</h1>
	<div class="panel panel-warning">
		<div class="panel-heading">
			<h3 class="panel-title">來自會員編輯的路線</h3>
		</div>
		<div class="panel-body">
			...
			<%@ include file="pages/page1_listfrommemno.file"%>
			<div class="table-responsive">
				<table class="table table-hover">
					...
					<jsp:useBean id="rotclsSvc" scope="page"
						...
						<c:forEach var="rotVO" items="${listRots_frommemno}"
			...
			<%@ include file="pages/page3_listfrommemno.file"%>
		</div>
	</div>
</div>