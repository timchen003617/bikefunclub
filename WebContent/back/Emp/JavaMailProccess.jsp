...
<%
    ...
    String ch_name = request.getParameter("empacc");            //  String ch_name = "peter1"; 
	String passRandom = (String)request.getAttribute("emppw");   //String passRandom = request.getParameter("passRandom");
	...
	String to           = request.getParameter("empemail"); //String to = request.getParameter("email");
	String Subject      = "您的密碼";
