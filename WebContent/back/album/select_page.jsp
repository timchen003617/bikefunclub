...
<html>
<head><title>IBM Album: Home</title></head>
<body bgcolor='white'>

	<table border='1' cellpadding='5' cellspacing='0' width='400'>
		<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
			<td><h3>IBM Album: Home</h3>	<font color=red>( MVC )</font></td></tr></table>

<p>This is the Home page for IBM Album: Home</p>
...
<ul>
  <li><a href='<%=request.getContextPath() %>/back/album/listAllAlbum.jsp'>List</a> all Album. </li> <br><br>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back/album/addAlbum.jsp'>Add</a> a new Albcls.</li>
</ul>
